...
CREATE TABLE `sys_login_info`  (
  ...
  INDEX `idx_sys_login_info_s`(`status` ASC) USING BTREE,
  INDEX `idx_sys_login_info_lt`(`login_time` ASC) USING BTREE
...
CREATE TABLE `sys_role`  (
  ...
  `del_flag` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '0' COMMENT '删除标志（n代表存在 y代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
...
CREATE TABLE `sys_user`  (
  ...
  `sex` tinyint NULL DEFAULT 2 COMMENT '用户性别（0女 1男 2未知）',
